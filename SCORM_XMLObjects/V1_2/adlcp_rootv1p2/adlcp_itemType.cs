...
namespace adlcp_rootv1p2
{
    ...
    public class adlcp_itemType : imscp.itemType
    {
        ...
        public adlcp_itemType() : base()
        {
            SetCollectionParents();
        }

        public adlcp_itemType(XmlDocument doc) : base(doc)
        {
            SetCollectionParents();
        }

        public adlcp_itemType(XmlNode node) : base(node)
        {
            SetCollectionParents();
        }

        public adlcp_itemType(Altova.Node node) : base(node)
        {
            SetCollectionParents();
        }
        ...
        {
            get { return DomChildCount(NodeType.Element, "http://www.adlnet.org/xsd/adlcp_rootv1p2", "prerequisites"); }
        }
        ...
        {
            get { return GetprerequisitesAt(0); }
        }
        ...
        public class prerequisitesEnumerator : IEnumerator
        {
            ...
            {
                get { return (parent.GetprerequisitesAt(nIndex)); }
            }
        ...
        {
            get { return DomChildCount(NodeType.Element, "http://www.adlnet.org/xsd/adlcp_rootv1p2", "maxtimeallowed"); }
        }
        ...
        {
            get { return GetmaxtimeallowedAt(0); }
        }
        ...
        public class maxtimeallowedEnumerator : IEnumerator
        {
            ...
            {
                get { return (parent.GetmaxtimeallowedAt(nIndex)); }
            }
        ...
        {
            get { return DomChildCount(NodeType.Element, "http://www.adlnet.org/xsd/adlcp_rootv1p2", "timelimitaction"); }
        }
        ...
        {
            get { return GettimelimitactionAt(0); }
        }
        ...
        public class timelimitactionEnumerator : IEnumerator
        {
            ...
            {
                get { return (parent.GettimelimitactionAt(nIndex)); }
            }
        ...
        {
            get { return DomChildCount(NodeType.Element, "http://www.adlnet.org/xsd/adlcp_rootv1p2", "datafromlms"); }
        }
        ...
        public class datafromlmsEnumerator : IEnumerator
        {
            ...
            {
                get { return (parent.GetdatafromlmsAt(nIndex)); }
            }
        ...
        {
            get { return DomChildCount(NodeType.Element, "http://www.adlnet.org/xsd/adlcp_rootv1p2", "masteryscore"); }
        }
        ...
        {
            get { return GetmasteryscoreAt(0); }
        }
        ...
        public class masteryscoreEnumerator : IEnumerator
        {
            ...
            {
                get { return (parent.GetmasteryscoreAt(nIndex)); }
            }
        ...
        {
            get { return DomChildCount(NodeType.Element, "http://www.imsproject.org/xsd/imscp_rootv1p1p2", "item"); }
        }
        ...
        public class itemEnumerator : IEnumerator
        {
            ...
            {
                get { return (parent.GetitemAt(nIndex)); }
            }
